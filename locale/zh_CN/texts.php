...
// ------------------------------------------------------------------------------------------
$TLS_htmltext_title['printReqSpec'] = "打印需求规格"; //已校对
$TLS_htmltext['printReqSpec'] = "<h2>目的:</h2>
<p>你可以使用需求规格中的某些需求或者测试项目中的所有需求生成文档</p>
<h2>开始:</h2>
<ol>
<li>
<p>选择需要显示的部分需求,然后点击需求规格或者测试项目.
一个可打印的页面就会显示出来.</p>
</li>
<li><p>使用导航栏下拉框中的\"Show As\" 来决定把信息显示成HTML或者类Word文档.
更多信息请查看: <span class=\"help\" onclick=\"javascript:open_help_window('printFilter',
'{$locale}');\">帮助</span> .</p>
<li><p>使用浏览器的打印功能来输出信息.<br />
 <i>注意:保证只打印右边的框架.</i></p></li>
</ol>";
